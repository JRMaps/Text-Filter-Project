      ...
      <SafeAreaView style = {styles.container}>
        ...
        <View style={styles.formSection}>
          ...
          <TextInput
            ...
            secureTextEntry
          />
          <Text style={styles.forgotPass} onPress={() => console.log('Forgot password pressed')}>
            Forgot Password?
          </Text>
        </View>
        {/*Buttons Section */}
        <View>
          <TouchableOpacity style={[styles.buttonBase, styles.loginButton]} onPress={handleLogin}>
